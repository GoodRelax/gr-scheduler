...
//      neither sizes it), table T-206 (every settled grab margin -- S-250 to
//      S-290 -- and no row for this one), table T-023d, tables T-201 / T-203 /
...
describe('UF-61 -- ⛔ LEFT FAILING: FR-051 calls the divider a grab band', () => {
  ...
  // settled grab margin (S-250 to S-290) and has no row for this one -- so no
