...
> **この実例の暦の前提**: **1 日 8 時間・月〜金稼働・祝日なし**。`2026-07-01` は水曜である。
> 稼働日は 7/1・2・3 と 7/8・9・10 の **6 日 = 48 時間**で、`Duration` はこれと一致する。
> ⚠️ **`Duration` は中断の空きを含まない**（空きは `Finish` を後ろへ押し出すだけ）。
> **暦を変えると `Duration` と `Finish` の関係も変わる。** 数字だけを他所へ写さないこと。
...
<Task>
  ...
  <Duration>PT48H0M0S</Duration>       <!-- ISO8601: 48稼働時間 = 6稼働日 -->
  <!-- 実績（予実の右側・イナズマ線の元） -->
  <ActualStart>2026-07-01T09:00:00</ActualStart>
  <ActualFinish>2026-07-14T17:00:00</ActualFinish>  <!-- 遅延して着地（火） -->
  <PercentComplete>100</PercentComplete>
  <!-- 中断（スプリット） -->
  <Stop>2026-07-03T17:00:00</Stop>     <!-- ここで止まった（金） -->
  <Resume>2026-07-08T09:00:00</Resume> <!-- ここで再開（水） -->
...
> （`../07-plan-actual/plan-actual-decisions-ja.md`）。**`Start`/`Finish` の直後**にある。
