...
> 器の生成規則そのものは `../02-data-model/grs-data-model-ja.md` §7.1-1 が正。
...
**判定の規則は 1 文**: **その段の目盛が刻む単位 1 つぶんの幅に、ラベルが入るなら出す。**

```
段階 2 へ上がる   月 1 つの幅  = 30.4 × px/day  ≧ 「2026-01」が入る幅
段階 3 へ上がる   週 1 つの幅  =    7 × px/day  ≧ 「01-05」が入る幅
段階 4 へ上がる   日 1 つの幅  =    1 × px/day  ≧ 「05 月」が入る幅
```
