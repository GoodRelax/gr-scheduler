...
**正は `../07-plan-actual/handover-plan-actual-decisions-ja.md` §7。** 下は所属を見るための要約で、
...
> `../07-plan-actual/handover-plan-actual-decisions-ja.md` §2-6 の色を使うと
...
> 詳細と性能の実測は `../07-plan-actual/handover-plan-actual-decisions-ja.md` §2-7。
