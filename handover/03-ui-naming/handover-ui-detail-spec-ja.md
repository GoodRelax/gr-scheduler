...
**ポインタをキャンバスの上で 5 秒静止させたら、その場にヒントを出す。**
ポインタが動いたら消す。

| 事項 | 内容 |
|---|---|
| 出す条件 | ポインタがキャンバスの上にあり、**5 秒**動いていない |
| 消す条件 | ポインタが動く / キャンバスから出る / キーを押す |
...
> **静止で出す理由**: 迷っている人はポインタを止める。動かしている人は目的を持っている。
> **止まったことが「分からない」の合図**であり、押させて出すより早い。
