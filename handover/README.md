...
handover/
├── README.md                        この文書
├── NEXT-STEPS-ja.md                 実開発ステップ別の欠落一覧 19 件（着手前に読む）
...
7. **`NEXT-STEPS-ja.md` で残作業を引く。** 実開発のステップごとに「まだ決まっていないこと 19 件」と
