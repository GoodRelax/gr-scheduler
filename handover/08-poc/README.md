...
**2026-08-02 に 3 件とも処置した。** §6-2（縦の通り道）は**制約として確定**、
末尾 #5（Fit と LOD 閾値）は**罠 T-14 として反映**、#7（レベル減）は**制約 2 つだけ確定**。
**残るのは #7 の式そのものと、§6-2 の経路の引き方**で、どちらも `../NEXT-STEPS-ja.md` ステップ 6 にある。
