...
| | |
|---|---|
| **決まっていること** | **方針だけ** ＝「文字をさらに縮めるのではなく、**グループ LOD（軸B・`TaskGroup`）の深さ**を 1 つ減らす」（`07-plan-actual/handover-plan-actual-decisions-ja.md` §2-4-1・§5-3。軸は 2026-08-02 に確定）。フォント下限は 12px |
