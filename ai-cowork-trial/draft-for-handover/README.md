...
| — | `OPEN-ITEMS-ja.md` | **未決 2 件**（＋ **実測で決着 8 件**・**決定 6 件**） | 未決 |
...
そのために文書へ `revision` を持たせ、書き込み時に**基準版を照合し**、変更を revision スコープで通知する。
...
（`OPEN-ITEMS-ja.md` 決着-1 〜 決着-8）。**人間が開いている画面にエージェントが入ることも実測済み**
