// Schedule -- the document invariants, judged row by row of table T-220.
// @unit      UF-131  (docs/spec/05-07-design.md, table T-075)
...
import { compareDays, dayOf, serial, type CalendarDay } from './calendar-day'
import {
  DATE_COLUMNS,
  ENTITY_ROWS,
  type EntityRows,
