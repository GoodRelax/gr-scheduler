...
export interface GestureValuesTransition {
  readonly state: GestureValuesKey
  readonly event: GestureValuesEvent['type']
  readonly guard: string | null
  readonly to: string
  readonly effect: GestureValuesEffectName | null
...
export const GESTURE_VALUES_TRANSITIONS: readonly GestureValuesTransition[] = [
  {
    state: 'pointerPressStateMachine.notPressed',
    event: 'pointerPressed',
    guard: 'isDocumentChangingPress',
    to: 'pointerPressStateMachine.changingDocument',
    effect: null,
    effectArgument: null,
  },
  {
    state: 'pointerPressStateMachine.notPressed',
    event: 'pointerPressed',
    guard: 'not isDocumentChangingPress & isOnRepeatingEntry',
    to: 'pointerPressStateMachine.viewingDocument',
    effect: 'startEntryRepeat',
    effectArgument: null,
  },
  {
    state: 'pointerPressStateMachine.notPressed',
    event: 'pointerPressed',
    guard: 'not isDocumentChangingPress & not isOnRepeatingEntry',
    to: 'pointerPressStateMachine.viewingDocument',
    effect: null,
    effectArgument: null,
  },
  {
    state: 'pointerPressStateMachine.changingDocument',
    event: 'pointerReleased',
    guard: null,
    to: 'pointerPressStateMachine.notPressed',
    effect: null,
    effectArgument: null,
  },
  {
    state: 'pointerPressStateMachine.viewingDocument',
    event: 'pointerReleased',
    guard: null,
    to: 'pointerPressStateMachine.notPressed',
    effect: null,
  ...
  {
    state: 'pointerPressStateMachine.changingDocument',
    event: 'pressInterrupted',
    guard: 'isOnPaletteBand',
    to: 'pointerPressStateMachine.notPressed',
    effect: 'restorePaletteCorner',
    effectArgument: null,
  },
  {
    state: 'pointerPressStateMachine.changingDocument',
    event: 'pressInterrupted',
    guard: 'not isOnPaletteBand',
    to: 'pointerPressStateMachine.notPressed',
    effect: null,
    effectArgument: null,
  },
  ...
  {
    state: 'pointerPressStateMachine.viewingDocument',
    event: 'entryRepeatTimeElapsed',
    guard: 'isOnRepeatingEntry',
    to: 'pointerPressStateMachine.viewingDocument',
    effect: 'repeatHeldEntry',
    effectArgument: null,
  },
  {
    state: 'rowGrabStateMachine.notGrabbed',
    event: 'pointerPressed',
    guard: 'isRowGrabStrip',
    to: 'rowGrabStateMachine.axisUndecided',
    effect: null,
    effectArgument: null,
  },
  {
    state: 'rowGrabStateMachine.axisUndecided',
    event: 'pointerReleased',
    guard: null,
    to: 'rowGrabStateMachine.notGrabbed',
    effect: null,
    effectArgument: null,
  },
  {
    state: 'rowGrabStateMachine.changingPosition',
    event: 'pointerReleased',
    guard: null,
    to: 'rowGrabStateMachine.notGrabbed',
    effect: null,
  ...
  {
    state: 'rowGrabStateMachine.changingDepth',
    event: 'pointerReleased',
    guard: null,
    to: 'rowGrabStateMachine.notGrabbed',
    effect: null,
  ...
  {
    state: 'rowGrabStateMachine.axisUndecided',
    event: 'rowGrabAxisSettled',
    guard: 'isPositionAxis',
    to: 'rowGrabStateMachine.changingPosition',
    effect: null,
    effectArgument: null,
  },
  {
    state: 'rowGrabStateMachine.axisUndecided',
    event: 'rowGrabAxisSettled',
    guard: 'not isPositionAxis',
    to: 'rowGrabStateMachine.changingDepth',
    effect: null,
    effectArgument: null,
  },
]
