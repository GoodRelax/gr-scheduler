...
export interface SelectionValuesTransition {
  readonly state: SelectionValuesKey
  readonly event: SelectionValuesEvent['type']
  readonly guard: string | null
  readonly to: string
  readonly effect: SelectionValuesEffectName | null
...
export const SELECTION_VALUES_TRANSITIONS: readonly SelectionValuesTransition[] = [
  {
    state: 'selection',
    event: 'rowsPicked',
    guard: null,
  ...
  {
    state: 'selectionStateMachine.nothingSelected',
    event: 'objectsPicked',
    guard: 'hasPickedObjects',
    to: 'selectionStateMachine.objectsSelected',
    effect: null,
    effectArgument: null,
  },
  {
    state: 'selectionStateMachine.objectsSelected',
    event: 'objectsPicked',
    guard: 'hasPickedObjects',
    to: 'selectionStateMachine.objectsSelected',
    effect: null,
  ...
  },
  {
    state: 'selectionStateMachine.objectsSelected',
    event: 'objectsPicked',
    guard: 'not hasPickedObjects',
    to: 'selectionStateMachine.nothingSelected',
    effect: null,
    effectArgument: null,
  },
  {
    state: 'selectionStateMachine.objectsSelected',
    event: 'emptyAreaClicked',
    guard: null,
    to: 'selectionStateMachine.nothingSelected',
    effect: null,
    effectArgument: null,
  ...
  {
    state: 'selectionStateMachine.objectsSelected',
    event: 'selectionEscapePressed',
    guard: 'isRungSelection',
    to: 'selectionStateMachine.nothingSelected',
    effect: null,
    effectArgument: null,
  },
  {
    state: 'selectionStateMachine.objectsSelected',
    event: 'selectionSettleKeyPressed',
    guard: null,
    to: 'selectionStateMachine.nothingSelected',
    effect: null,
    effectArgument: null,
  ...
  {
    state: 'selectionStateMachine.objectsSelected',
    event: 'selectionPruned',
    guard: 'hasRemainingObjects',
    to: 'selectionStateMachine.objectsSelected',
    effect: null,
    effectArgument: null,
  },
