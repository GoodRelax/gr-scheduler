...
import {
  claimedFrames,
  fadeColumnsByFieldId,
  fadeOfCarried,
  writtenFadeDefinitions,
  writtenFadeValues,
  type ClaimedFrame,
  type FadeColumn,
...
/** @purity pure */
export function notice(at: string, what: string): MspdiNotice {
  return { at, what }
}
...
/** @purity pure */
export function childOf(element: XmlElement, name: string): XmlElement | null {
...
/** @purity pure */
export function textColumn(element: XmlElement, name: string): string | null {
  const child = childOf(element, name)
  return child === null ? null : leafText(child)
}

/** @purity pure */
export function integerColumn(element: XmlElement, name: string): number | null {
  return wholeNumberOf(textColumn(element, name))
}

/** @purity pure */
export function wholeNumberOf(raw: string | null | undefined): number | null {
...
/** @purity pure */
export function leaf(name: string, text: string): PlacedChild {
