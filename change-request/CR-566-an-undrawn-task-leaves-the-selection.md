...
> 状態: 当てた（2026-09-24）。E-01 と E-02 を仕様・原稿へ当て、`npm run gen` で刷り直した。E-03（Q16 の写しの置き場）も同じ日に原稿へ当てた（11 節）。E-04 〜 E-06（`DFC-806`、`JDG-410`、ハイライトボックスのダブルクリック）も同じ日に当てた（11 節）。
