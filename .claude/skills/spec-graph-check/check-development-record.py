...
def main():
    ...
    for name in sorted(os.listdir(RECORDS)):
        ...
        # test-inventory.md is the fourteenth: generated by
        # tools/generate_test_inventory.py, one row per test file, keyed by
        # test file; check 71 holds it to the tests instead.
