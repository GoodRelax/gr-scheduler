...
ARTIFACTS = [
    ...
    ('src/use-case/advance-screen-session/notice-values.ts',
     'state-machines.json'),
    ('src/use-case/advance-screen-session/gesture-values.ts',
     'state-machines.json'),
    ('src/use-case/advance-screen-session/file-flow-values.ts',
     'state-machines.json'),
    ('src/use-case/advance-screen-session/field-entry-values.ts',
     'state-machines.json'),
    ('src/use-case/advance-screen-session/selection-values.ts',
     'state-machines.json'),
