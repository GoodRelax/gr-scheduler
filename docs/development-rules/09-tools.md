...
| 種別 | 本数 | 置き場の内訳 |
|---|---|---|
| 門 | **30** | `.claude/skills/spec-graph-check/` に 26、`tools/` に 2、`docs/review/` に 1、`tools/parity/` に 1 |
