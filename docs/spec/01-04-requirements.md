...
| HF-2 | **開く操作子は、その行の配下をすべて開くこと（MUST）** —— 表 T-015 の `HR-3` である。⚠️ **以前は「1 段だけ開く」と定めていた** —— ⛔ **閉じる操作子が畳むものと対にならず、畳んだものを開く組み合わせが存在しなかった**（利用者の裁定、2026-08-25）|
